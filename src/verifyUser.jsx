...
class VerifyUser extends Component {
    ...
    onSubmit = (event) => {
        ...
        axios.post("http://localhost:4000/app/verify", formData)
                ...
                <div className='container'>
                    <div className='form-div'>
                        ...
                        <form>
                            ...
                            <button onClick={this.onSubmit} className="'btn btn-danger btn block" >Submit</button>
