            ...
            <nav className="header">
                ...
                <div className="header__right">
                    ...
                    <div className="user-wrapper">
                        ...
                        {this.state.user && (<div className="nav-item">Welcome {this.state.user} </div>)}
                        {this.state.user && (<div className="nav-item"> <Link to='/logOut' className="psr">
                            <p>Logout</p>
                        </Link></div>)}
                        {!this.state.user && (<div className="nav-item"><Link to='/LogIn' className="psr">
                            <p>Login</p>
                        </Link></div>)}
                        {!this.state.user && (<div className="nav-item"><Link to='/Signup' className="psr">
                            <p>Register</p>
                        </Link></div>)}
